    ...
    <div className="flex flex-col lg:bg-gray-100 bg-white pl-14  lg:pl-0 lg:items-center w-screen lg:w-[100%] lg:h-screen">
      ...
      <div className=" flex flex-col items-start pt-10">
        <div className="bg-gray-200 lg:bg-inherit rounded-lg pt-4 lg:pt-0 pr-4 lg:pr-0 pl-4 lg:pl-0 pb-4 lg:pb-0 w-[90%] lg:w-full ">
          ...
          <div className="relative pt-6 lg:pt-2 ">
            <button
              className="bg-blue-600 text-white rounded-lg p-2 text-[16px] flex text-center justify-center items-center w-[100%] lg:w-[70%]"
              onClick={handleDropdownToggle}
            >
              I want to
              <span className="text-white pl-3 text-[10px] lg:flex hidden">
                {" "}
                &#9660;{" "}
              </span>{" "}
            </button>
      ...
      <div className=" flex flex-col pt-12 items-start">
        <div className=" bg-gray-200 lg:bg-inherit rounded-lg pt-4 lg:pt-0 pr-4 lg:pr-0 pl-4 lg:pl-0 pb-4 lg:pb-0 w-[90%] lg:w-full ">
          ...
          <div className="hidden lg:flex lg:flex-col  border-b-2 border-gray-300 pb-3 pt-4 ">
